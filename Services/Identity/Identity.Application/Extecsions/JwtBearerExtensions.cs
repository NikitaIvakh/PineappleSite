...
namespace Identity.Application.Extecsions
{
    ...
    {
        public static List<Claim> CreateClaims(this ApplicationUser user, List<IdentityRole<string>> roles)
        {
        ...
        public static JwtSecurityToken CreateJwtToken(this IConfiguration configuration, List<Claim> authClaims)
        {
