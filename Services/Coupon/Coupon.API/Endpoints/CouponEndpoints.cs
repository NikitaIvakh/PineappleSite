...
public sealed class CouponEndpoints : ICarterModule
{
    ...
    private static async Task<Results<Ok<Result<GetCouponDto>>, BadRequest<string>>> GetCouponById(int couponId,
    ...
    private static async Task<Results<Ok<Result<Unit>>, BadRequest<string>>> UpdateCoupon(int couponId, ISender sender,
    ...
    private static async Task<Results<Ok<Result<Unit>>, BadRequest<string>>> DeleteCoupon(int couponId, ISender sender,
