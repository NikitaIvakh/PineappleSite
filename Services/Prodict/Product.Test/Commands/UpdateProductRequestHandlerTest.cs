...
// {
//     public class UpdateProductRequestHandlerTest : TestCommandHandler
//     {
//         [Fact]
//         public async Task UpdateProductDtoRequestHandlerTest_Success()
//         {
//             // Arrange
//             var handler = new UpdateProductRequestHandler(Repository, UpdateLogger, Mapper, UpdateValidator, HttpContextAccessor, MemoryCache);
...
//
//             // Act
//             var result = await handler.Handle(new UpdateProductRequest
//             {
