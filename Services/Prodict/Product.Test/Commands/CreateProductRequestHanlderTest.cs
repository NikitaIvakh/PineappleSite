...
//         {
//             // Arrange
//             var handler = new CreateProductRequestHandler(Repository, CreateLogger, Mapper, CreateValidator, HttpContextAccessor, MemoryCache);
...
//
//             // Act
//             var result = await handler.Handle(new CreateProductRequest
//             {
