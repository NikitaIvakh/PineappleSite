...
namespace PineappleSite.Presentation.Services.Products
{
    ...
    public partial interface IProductClient
    {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ProductExceptions">A server side error occurred.</exception>
        System.Threading.Tasks.Task<ProductAPIResponse> ProductDELETEAsync(string id, DeleteProductDto body);

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Success</returns>
        /// <exception cref="ProductExceptions">A server side error occurred.</exception>
        System.Threading.Tasks.Task<ProductAPIResponse> ProductDELETEAsync(string id, DeleteProductDto body, System.Threading.CancellationToken cancellationToken);
    ...
    public partial class ProductClient : IProductClient
    {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ProductExceptions">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ProductAPIResponse> ProductDELETEAsync(string id, DeleteProductDto body)
        {
            return ProductDELETEAsync(id, body, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Success</returns>
        /// <exception cref="ProductExceptions">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ProductAPIResponse> ProductDELETEAsync(string id, DeleteProductDto body, System.Threading.CancellationToken cancellationToken)
        {
            if (id == null)
                throw new System.ArgumentNullException("id");
